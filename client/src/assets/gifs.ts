...
export const gifsGoblin = {
  padrao: "/img/monstros/goblin.gif",
  atk: "/img/monstros/goblin-ataque.gif",
  damage: "/img/monstros/goblin-dano.gif",
  morte: "/img/monstros/goblin-dano.gif",
} as const;
